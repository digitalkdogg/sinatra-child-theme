...
if ( ! function_exists( 'enqueue_custom_stuff' ) ) {
    ...
    wp_enqueue_script( 'customjs', get_stylesheet_directory_uri() . '/assets/js/min/base.min.js' , array(), '1.0.1', false);
    wp_enqueue_style( 'millwood-base', get_stylesheet_directory_uri() . '/assets/css/base.css', array(), '1.0.1', false);
    ...
    if (is_page_template( 'page-templates/news-page.php' )) {
            ...
            wp_enqueue_style( 'donatecss', get_stylesheet_directory_uri() . '/assets/css/news.css', array(), '1.0.1', false );
    }
  }
}
...
* @return $object, or null if none.  */
 ...
 function get_hero_image() {
  ...
  if (wp_is_mobile() == true) {
    ...
    wp_enqueue_style('herocss', get_stylesheet_directory_uri() . '/assets/css/hero.css', array(), '1.0.1', false);
